frappe.query_reports["Stock Report - Cumulative"] = {
    ...
    formatter: function(value, row, column, data, default_formatter) {
        ...
        // Original item code link kept exactly as is
        // + small KBC icon added next to it
...
// ─────────────────────────────────────────────────────────────────────────────
// STEP 1 — Click 📦 icon → KBC popup (Kalvert / Buffing / Charak)
// ─────────────────────────────────────────────────────────────────────────────
            ...
            warehouses.forEach(wh => {
                ...
                body += `<tr>
                    ...
                    <td style="padding:6px 10px;text-align:right">
                        ${k > 0
                            ? `<a href="#" class="kbc-drill-src"
                                data-item="${base}K" data-label="Kalvert"
                    ...
                    <td style="padding:6px 10px;text-align:right">
                        ${b > 0
                            ? `<a href="#" class="kbc-drill-src"
                                data-item="${base}B" data-label="Buffing"
                    ...
                    <td style="padding:6px 10px;text-align:right">
                        ${c > 0
                            ? `<a href="#" class="kbc-drill-src"
                                data-item="${base}C" data-label="Charak"
...
// ─────────────────────────────────────────────────────────────────────────────
// STEP 2 — Click qty → warehouse drill-down
// ─────────────────────────────────────────────────────────────────────────────
